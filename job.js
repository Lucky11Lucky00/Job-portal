// Sample job data
const jobs = [
    { title: 'Frontend Developer', location: 'kolkata', type: 'Full-time', salary: '80,000 - 1,00,000' },
    { title: 'Backend Developer', location: 'Mumbai', type: 'Full-time', salary: '90,000 - 1,10,000' },
    { title: 'UI/UX Designer', location: 'vizag', type: 'Contract', salary: '70,000 - 90,000' },
    { title: 'Data Scientist', location: 'Kerala', type: 'Full-time', salary: '100,000 - 120,000' },
    { title: 'Software Engineer', location: 'America' , type: 'Part-time', salary: '60,000 - 80,000' },
];
